...
The end-to-end virtual camera: phone-side camera capture, MJPEG encoding, and transmission on stream ID 1; desktop-side reassembly, decoding, and presentation as a v4l2loopback virtual webcam; camera controls (toggle, facing, resolution) and stream-state indication in both UIs.
