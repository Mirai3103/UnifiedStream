...
Zero-configuration discovery of UnifiedStream desktops on the local network, the stable device identity that makes a peer recognisable across restarts, and the manual-address fallback for networks where multicast does not work.
